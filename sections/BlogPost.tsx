...
const DEFAULT_AVATAR =
  "https://saveincloud.com/wp-content/uploads/2024/09/Molde-foto-whatsapp-Joao.png";

const DEFAULT_PROPS: BlogPost = {
  title: "Aprenda como configurar backup Firebird",
  excerpt: "Excerpt goes here",
  authors: [
    {
      name: "João Victor Julião",
      email: "joao.juliao@saveincloud.com",
